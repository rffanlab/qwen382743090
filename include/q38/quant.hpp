...
inline constexpr std::size_t kQ6KBytesPerBlock = 210;
inline constexpr std::size_t kQ8KBytesPerBlock = 292;
inline constexpr std::size_t kQ8_1ValuesPerBlock = 32;
inline constexpr std::size_t kQ8_1BytesPerBlock = 36;
...
void dequantize_q6_k_block_cpu(const std::byte* block, std::array<float, kQ4KValuesPerBlock>& out);
